...
private:
  ...
  DEFINE_PARAMETERS(
      ...
      (ParamFloat<px4::params::QUAD_ESC_A>)_param_quad_esc_a,
      (ParamFloat<px4::params::QUAD_ESC_B>)_param_quad_esc_b,
      (ParamFloat<px4::params::QUAD_ESC_C>)_param_quad_esc_c,
