...
void MixerLinear::set_thrust_coeff(float k) { _k_thrust = k; }

void MixerLinear::set_torque_coeff(float k) { _k_torque = k; }
...
SquareMatrix<float, 4> MixerLinear::get_G_matrix() { return _invG.I(); }
